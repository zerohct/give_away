        ...
        <div className="mb-6">
          <div className="bg-red-50 p-4 rounded-lg border border-red-100 mb-4">
            ...
            <p className="text-gray-700">
              ...
              user account <strong>{userName}</strong> and all associated data.
            </p>
          </div>
          <p className="text-gray-600">
            Please confirm that you want to delete this user account. The user will no longer be able to access the system.
          </p>
        </div>
