...
export default function UpdateCampaignPage() {
  ...
  const { fetchCampaignById, updateCampaign, loading, currentCampaign } =
    useCampaign();
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // Extract the ID from the URL path (e.g., /admin/campaigns/edit/3)
      ...
      try {
        ...
        if (campaign) {
          ...
          if (campaign.media && campaign.media.length > 0) {
            if (campaign.media[0].base64Image) {
              setImagePreview(campaign.media[0].base64Image);
            } else if (campaign.media[0].url) {
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
                ...
                <p className="opacity-90 mt-2">
                  Update your campaign details and make it even more effective
                </p>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 rounded-lg p-5 border-l-4 border-blue-500">
                      ...
                      <p className="text-blue-600 text-sm">
                        Update the fundamental details of your campaign
                      </p>
                    </div>
