...
function Register() {
  ...
  const handleSubmit = useCallback(
    ...
    [firstName, lastName, email, password, confirmPassword, register]
  );
  ...
  return (
    <>
      <Head>
        <title>
          Đăng ký | {appConfig.site.name} - Nền tảng từ thiện minh bạch
        </title>
        <meta
          name="description"
          content="Đăng ký tài khoản {appConfig.site.name} để tham gia các hoạt động từ thiện, quyên góp và theo dõi các dự án hỗ trợ cộng đồng."
        />
        <meta
          name="keywords"
          content="đăng ký, tài khoản từ thiện, quyên góp, hỗ trợ cộng đồng, {appConfig.site.name}"
        />
        <meta property="og:title" content="Đăng ký | {appConfig.site.name}" />
        <meta
          property="og:description"
          content="Đăng ký tài khoản {appConfig.site.name} để tham gia các hoạt động từ thiện, quyên góp và theo dõi các dự án hỗ trợ cộng đồng."
        />
        <meta property="og:image" content={logo.src} />
        <link rel="canonical" href={`${appConfig.site.url}/register`} />
      </Head>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-center text-gray-600 mb-6">
                Tạo tài khoản để tham gia cùng GiveAway
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2 relative">
                  ...
                  <input
                    ...
                    autoComplete="new-password"
                    className="block w-full pl-4 pr-10 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 disabled:bg-gray-100 disabled:text-gray-500 transition-colors duration-200"
                    aria-label="Xác nhận mật khẩu đăng ký"
                  />
                  <button
                    type="button"
                    aria-label={
